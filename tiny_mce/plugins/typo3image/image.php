...
<head>
	<title>{#typo3image_dlg.dialog_title}</title>
	...
	<script type="text/javascript">
		var aktuelleBreite = 100;
		function previewImage(image) {
			var url="http://"+tinyMCEPopup.editor.documentBaseURI.host+tinyMCEPopup.editor.documentBaseURI.path;
			var imgURL=document.getElementById(image).value.replace(url,"");
			if(imgURL) {
				document.images["prevpic_"+image].src=url+imgURL;
				document.getElementById("bubble_"+image).style.height=document.images["prevpic_"+image].height+"px";
				document.getElementById("bubble_"+image).style.visibility="visible"
			}
		}
	</script>
</head>
    ...
    <form onsubmit="ImageDialog.insert();return false;" action="#">
		<div class="tabs">
			<ul>
				...
				<li id="appearance_tab"><span><a href="javascript:mcTabs.displayTab('appearance_tab','appearance_panel');" onmousedown="return false;">{#typo3image_dlg.tab_appearance}</a></span></li>
				<li id="advanced_tab"><span><a href="javascript:mcTabs.displayTab('advanced_tab','advanced_panel');" onmousedown="return false;">{#typo3image_dlg.tab_advanced}</a></span></li>
			</ul>
		</div>
		...
		<div class="panel_wrapper">
			<div id="general_panel" class="panel current">
				<fieldset>
						<legend>{#typo3image_dlg.general}</legend>
				...
				<fieldset>
					<legend>{#typo3image_dlg.preview}</legend>
					<div id="prev"></div>
				</fieldset>
			</div>
					...
					<table border="0" cellpadding="4" cellspacing="0">
						<tr>
							...
							<td><select id="align" name="align" onchange="ImageDialog.updateStyle('align');ImageDialog.changeAppearance();">
									...
									<option value="bottom">{#typo3image_dlg.align_bottom}</option>
									<option value="text-top">{#typo3image_dlg.align_texttop}</option>
							...
							<td rowspan="6" valign="top">
								<div class="alignPreview">
									<img id="alignSampleImg" src="images/sample.gif" alt="{#typo3image_dlg.example_img}" />
						...
						<tr>
							...
							<td><table border="0" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td><label id="constrainlabel" for="constrain">{#typo3image_dlg.constrain_proportions}</label></td>
									</tr>
								</table></td>
						</tr>
			...
			<div id="advanced_panel" class="panel">
				<fieldset>
					<legend>{#typo3image_dlg.swap_image}</legend>
					...
					<label id="onmousemovechecklabel" for="onmousemovecheck">{#typo3image_dlg.alt_image}</label>
				...
				<fieldset>
					<legend>{#typo3image_dlg.misc}</legend>
					...
					<table border="0" cellpadding="4" cellspacing="0">
						...
						<tr>
							<td class="column1"><label id="longdesclabel" for="longdesc">{#typo3image_dlg.long_desc}</label></td>
							<td><table border="0" cellspacing="0" cellpadding="0">
									<tr>
